...
```bash
git remote add encore encore://anonymous-job-sharing-app-syzi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/anonymous-job-sharing-app-syzi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/anonymous-job-sharing-app-syzi/settings/integrations/github)
